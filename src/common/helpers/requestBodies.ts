...
export const getUserSelPaginated = ({ skip, take, filters, sorts }: Dictionary): IRequestBodyPaginated => ({
    methodCollection: "UFN_USERS_PAG_SEL",
    methodCount: "UFN_USERS_PAG_COUNT",
    parameters: {
        skip,
        take,
        filters,
...
export const getdashboardoperativoEncuesta3Sel = ({
    startdate,
    enddate,
    channel,
    group,
...
export const getdashboardoperativoEncuestaSel = ({
    startdate,
    enddate,
    channel,
    group,
...
export const getdashboardoperativoEncuesta3Seldata = ({
    startdate,
    enddate,
    channel,
    group,
...
export const getdashboardoperativoEncuesta2Seldata = ({
    startdate,
    enddate,
    channel,
    group,
...
export const personInsValidation = ({
    id,
    phone,
    email,
    alternativephone,
...
export const insAutomatizationRules = ({
    id,
    description,
    status,
    type,
...
export const updateColumnsLeads = ({
...
export const insSDLead = (
    lead: IServiceDeskLead2 | IServiceDeskLead,
    operation: 'UPDATE' | 'INSERT' | 'DELETE' = 'INSERT',
): IRequestBody => ({
...
export const getPaginatedSDLead = ({
    skip,
    take,
    filters,
    sorts,
...
export const heatmapresumensel = ({
...
export const heatmappage1detail = ({
    communicationchannel,
    startdate,
    enddate,
    closedby,
...
export const heatmappage2detail1 = ({
    communicationchannel,
    startdate,
    enddate,
    closedby,
...
export const heatmappage2detail2 = ({
    communicationchannel,
    startdate,
    enddate,
    closedby,
...
export const heatmappage3detail = ({
    communicationchannel,
    startdate,
    enddate,
    horanum,
...
export const leadHistoryIns = ({
    ...
    status,
    operation,
}: ICrmLeadHistoryIns): IRequestBody => ({
...
export const billingSupportIns = ({
    year,
    month,
    plan,
    basicfee,
...
export const billingConfigurationIns = ({
    ...
    description,
    status,
    whatsappconversationfreequantity,
    freewhatsappchannel,
    usercreateoverride,
    channelcreateoverride,
    vcacomissionperhsm,
    vcacomissionpervoicechannel,
    plancurrency,
    vcacomission,
    basicanualfee,
    type,
...
export const billingConversationIns = ({
    id,
    year,
    month,
    countrycode,
    ...
    plancurrency,
    businessutilityfee,
    businessauthenticationfee,
    businessmarketingfee,
    usergeneralfee,
    freequantity,
    username,
    operation,
...
export const getBillingPeriodSel = ({
    corpid,
    orgid,
    year,
    month,
...
export const billingPeriodUpd = ({
    ...
    billingexchangerate,
    agentcontractedquantity,
    agentplancurrency,
    agentadditionalfee,
    agenttotalfee,
    agentaddlimit,
    agentmode,
    channelothercontractedquantity,
    channelotheradditionalfee,
    channelwhatsappcontractedquantity,
    channelwhatsappadditionalfee,
    channelotherquantity,
    channelwhatsappquantity,
    channeltotalfee,
    channelwhatsappfreequantity,
    channeladdlimit,
    conversationuserplancurrency,
    conversationuserserviceadditionalfee,
    conversationuserservicevcafee,
    conversationusermetacurrency,
    conversationuserservicefee,
    conversationuserservicetotalfee,
    conversationbusinessplancurrency,
    conversationbusinessutilityadditionalfee,
    ...
    conversationbusinessauthenticationvcafee,
    conversationbusinessmarketingvcafee,
    conversationbusinessmetacurrency,
    conversationbusinessutilitymetafee,
    conversationbusinessauthenticationmetafee,
    conversationbusinessmarketingmetafee,
    conversationbusinessutilitytotalfee,
    conversationbusinessauthenticationtotalfee,
    conversationbusinessmarketingtotalfee,
    conversationplancurrency,
    contactcalculatemode,
    contactcountmode,
    contactuniquelimit,
    contactuniquequantity,
    contactplancurrency,
    contactuniqueadditionalfee,
    contactuniquefee,
    contactwhatsappquantity,
    contactotherquantity,
    contactotheradditionalfee,
    contactwhatsappadditionalfee,
    contactotherfee,
    contactwhatsappfee,
    contactfee,
    messagingplancurrency,
    messagingsmsadditionalfee,
    messagingsmsvcafee,
    messagingsmsquantity,
    messagingsmsquantitylimit,
    messagingsmstotalfee,
    messagingmailadditionalfee,
    messagingmailvcafee,
    messagingmailquantity,
    messagingmailquantitylimit,
    messagingmailtotalfee,
    voicevcacomission,
    consultingplancurrency,
    consultinghourtotal,
    consultinghourquantity,
    consultingcontractedfee,
    consultingextrafee,
    consultingtotalfee,
    consultingprofile,
    consultingadditionalfee,
    additionalservice01,
    additionalservice01fee,
    additionalservice02,
    additionalservice02fee,
    additionalservice03,
    additionalservice03fee,
    invoiceid,
    status,
    force,
}: Dictionary): IRequestBody => ({
...
export const inputValidationins = ({
    id,
    operation,
    description,
    inputvalue,
...
export const getHistoryStatusConversation = (
    personid: number,
...
export const updateAppsettingInvoice = ({
    ruc,
    businessname,
    tradename,
    fiscaladdress,
    ...
    ticketcorrelative,
    invoicecreditserie,
    invoicecreditcorrelative,
    ticketcreditserie,
    ticketcreditcorrelative,
    detraction,
    detractioncode,
    detractionaccount,
    operationcodeperu,
...
export const billingMessagingIns = ({
    year,
    month,
    id,
    pricepersms,
